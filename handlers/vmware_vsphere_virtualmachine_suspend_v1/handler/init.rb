...
class VmwareVsphereVirtualmachineSuspendV1
  ...
  # virtual machine that is to be suspended.  Once located, it sends a signal 
  # to the VM on and waits for the VM to notify it that it is starting the
  # suspend sequence.
  #
  # This is a required method that is automatically called by the Kinetic Task
  # Engine.
  ...
  def execute()
    ...
    begin
      # Tell the virtual machine to suspend
