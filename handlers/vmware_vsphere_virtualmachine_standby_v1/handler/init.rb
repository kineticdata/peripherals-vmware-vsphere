...
class VmwareVsphereVirtualmachineStandbyV1
  ...
  # virtual machine that is to be set tp standby.  Once located, it sends a signal 
  # to set the VM to standby.
  #
  # This is a required method that is automatically called by the Kinetic Task
  # Engine.
  #
